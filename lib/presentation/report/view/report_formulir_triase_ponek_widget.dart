...
class ReportFormulirTriasePonekWidget extends StatefulWidget {
  const ReportFormulirTriasePonekWidget({super.key});

  @override
  State<ReportFormulirTriasePonekWidget> createState() =>
      _ReportFormulirTriaseWidgetState();
}

class _ReportFormulirTriaseWidgetState
    extends State<ReportFormulirTriasePonekWidget> {
            ...
            child: RawScrollbar(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  // Padding(
                  //   padding: EdgeInsets.all(8.sp),
                  //   child: const HeaderReportHarapanWidget(),
                  // ),
                  Container(
                    margin:
