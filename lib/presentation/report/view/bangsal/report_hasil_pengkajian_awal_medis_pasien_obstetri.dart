...
class ReportHasilPengkajianAwalMedisPasienObsetri extends StatelessWidget {
  const ReportHasilPengkajianAwalMedisPasienObsetri({super.key});
                      ...
                      children: [
                        ...
                        Center(
                          child: Column(
                            children: [
                              Text(
                                "PENGKAJIAN AWAL MEDIS PASIEN OBSTETRI & GINEKOLOGI",
                                textAlign: TextAlign.center,
                                style: blackTextStyle.copyWith(
                                    fontWeight: FontWeight.bold),
                              ),
                              Text(
                                "( Asessmen ini harus sudah selesai sebelum 24 jam sejak pasien masuk )",
                                textAlign: TextAlign.center,
