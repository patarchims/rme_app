...
class ReportHasilRawatInapBedahWidget extends StatelessWidget {
  const ReportHasilRawatInapBedahWidget({super.key});
                      ...
                      children: [
                        ...
                        Center(
                          child: Column(
                            children: [
                              Text(
                                "PENGKAJIAN AWAL PASIEN RAWAT INAP BEDAH",
                                textAlign: TextAlign.center,
                                style: blackTextStyle.copyWith(
                                    fontWeight: FontWeight.bold),
                              ),
                              Text(
                                "( Asessmen ini harus sudah selesai sebelum 24 jam pasien diperiksan oleh dokter bedah )",
                                textAlign: TextAlign.center,
