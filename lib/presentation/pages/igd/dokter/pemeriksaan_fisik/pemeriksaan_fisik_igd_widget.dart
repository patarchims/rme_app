...
class PemeriksaanFisikIGDContentWidget extends StatelessWidget {
  const PemeriksaanFisikIGDContentWidget({super.key});
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TitleWidget.boxPemeriksaanFisik(
                                  title: "Lain-lain",
                                  value: state
                                      .pemeriksaanFisikIgdModel.leherLainnya,
                                  onChanged: (value) {
                                    context.read<PemeriksaanFisikBloc>().add(
                                        PemeriksaanFisikEvent
                                            .leherLainnyaOnchanged(
                                                value: value));
                                  }),
                              ...
                              TitleWidget.boxPemeriksaanFisik(
                                  title: "Dinding Dada",
                                  value: state
                                      .pemeriksaanFisikIgdModel.dindingDada,
                                  onChanged: (value) {
                                    context.read<PemeriksaanFisikBloc>().add(
                              ...
                              TitleWidget.boxPemeriksaanFisik(
                                  title: "Suara Paru",
                                  value:
                                      state.pemeriksaanFisikIgdModel.suaraParu,
                                  onChanged: (value) {
                                    context.read<PemeriksaanFisikBloc>().add(
                              ...
                              TitleWidget.boxPemeriksaanFisik(
                                  title: "Dinding Perut",
                                  value: state
                                      .pemeriksaanFisikIgdModel.dindingPerut,
                                  onChanged: (value) {
                                    context.read<PemeriksaanFisikBloc>().add(
                              ...
                              Container(
                                ...
                                child: FormWidget.textArea(
                                  enabled: true,
                                  value:
                                      state.pemeriksaanFisikIgdModel.genetalia,
                                  onChanged: (value) {
                                    // ============================
                                    context.read<PemeriksaanFisikBloc>().add(
                                        PemeriksaanFisikEvent
                              ...
                              TitleWidget.boxPemeriksaanFisik(
                                  title: "Superior",
                                  value:
                                      state.pemeriksaanFisikIgdModel.superior,
                                  onChanged: (value) {
                                    context.read<PemeriksaanFisikBloc>().add(
                              ...
                              TitleWidget.boxPemeriksaanFisik(
                                  title: "Inferior",
                                  value:
                                      state.pemeriksaanFisikIgdModel.inferior,
                                  onChanged: (value) {
                                    context.read<PemeriksaanFisikBloc>().add(
