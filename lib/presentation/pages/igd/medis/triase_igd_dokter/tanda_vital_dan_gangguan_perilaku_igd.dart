                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      formBoxGSC(
                          valueE: state.tandaVitalIgdDokter.gcsE,
                          valueM: state.tandaVitalIgdDokter.gcsM,
                          valueV: state.tandaVitalIgdDokter.gcsV,
                          onChangedV: (vValue) {
                            context
                          ...
                          children: [
                            formBox(
                              ...
                              onChanged: (value) {
                                context
                                    .read<TandaVitalIgdDokterBloc>()
                                    .add(OnChangedKesadaranEvent(value: value));
                              },
                            ),
                            formBox(
                              title: "Pernapasan",
