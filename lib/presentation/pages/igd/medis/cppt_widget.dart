...
class CpptWidget extends StatefulWidget {
  const CpptWidget({super.key});

  @override
  State<CpptWidget> createState() => _CpptWidgetState();
}

class _CpptWidgetState extends State<CpptWidget> {
  ...
  String waktu = "";
  late TextEditingController _ppa;
