...
class RencanaTindakLanjutMedical extends StatefulWidget {
  const RencanaTindakLanjutMedical({super.key});

  @override
  State<RencanaTindakLanjutMedical> createState() =>
      _RencanaTindakLanjutIGDWigetState();
}

class _RencanaTindakLanjutIGDWigetState
    extends State<RencanaTindakLanjutMedical> {
  ...
  @override
  void initState() {
    _cariController = TextEditingController(text: "Cari ...");
    super.initState();
  }
