...
class RencanaTindakLanjutBedah extends StatefulWidget {
  const RencanaTindakLanjutBedah({super.key});

  @override
  State<RencanaTindakLanjutBedah> createState() =>
      _RencanaTindakLanjutIGDWigetState();
}

class _RencanaTindakLanjutIGDWigetState
    extends State<RencanaTindakLanjutBedah> {
  final _keyForm = GlobalKey<FormState>();
  late TextEditingController _cariController;
  late TextEditingController _alasanKonsulController;
  ...
  void dispose() {
    ...
    _alasanKonsulController.clear();
    _alasanKonsulController.dispose();
    _alasanKonsulController.dispose();
    super.dispose();
  }
  ...
  @override
  void initState() {
    _alasanKonsulController = TextEditingController();
                    ...
                    child: Card(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            titleContainer(title: "Alasan Opname"),
                            Container(
                              width: Get.width,
                              ...
                              child: FormWidget.textArea(
                                  maxLines: 5,
                                  enabled: true,
                                  value: state.alasanKonsulStr,
                                  validator: (value) {
                                    return value == ''
                                        ? "Alasan tidak boleh kosong"
                                        : null;
                                  },
                                  hinText: "Alasan Opname",
                                  onChanged: (e) {
                                    context.read<AsesmenIgdBloc>().add(
