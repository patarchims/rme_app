...
class AnamnesaSpesialisAnakContentWidget extends StatelessWidget {
  const AnamnesaSpesialisAnakContentWidget({super.key});
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TitleWidget.titleContainer(title: "Anamnesis"),
                              Padding(
                                padding: EdgeInsets.all(3.sp),
                                child: FormWidget.textArea(
                                  enabled: true,
                                  value: state.asesmentDokter.telaah,
                                  onChanged: (value) {
                                    context.read<AsesmenDokterBloc>().add(
                                        AsesmenDokterEvent.anamnesaOnchanged(
                                            value: value));
                                  },
                                  maxLines: 5,
                                ),
