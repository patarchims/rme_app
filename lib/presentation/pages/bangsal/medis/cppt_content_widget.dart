...
import 'package:hms_app/presentation/pages/bangsal/medis/catatan_keperawtaan_page_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (AppConstant.appSetup == AppSetup.methodist) {
      return TabbarHeaderContentWidget(
          ...
          children: menuMed.asMap().entries.map((e) {
            if (e.key == 0) {
              return const CatatanKeperawatanPageWidget();
            }
