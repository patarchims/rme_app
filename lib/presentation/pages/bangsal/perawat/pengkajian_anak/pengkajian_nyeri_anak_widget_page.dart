              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child:
                        TitleWidget.headerCenterTitle2(title: "Ekspresi Wajah"),
                  ),
                  Padding(
                    padding:
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 5.sp),
                    child: TitleWidget.headerCenterTitle2(title: "Tangisan"),
                  ),
                  Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: 2.sp, vertical: 1.sp),
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 5.sp),
                    child: TitleWidget.headerCenterTitle2(title: "Pola Napas"),
                  ),
                  Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: 2.sp, vertical: 1.sp),
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 5.sp),
                    child: TitleWidget.headerCenterTitle2(title: "KESADARAN"),
                  ),
                  Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: 2.sp, vertical: 1.sp),
                          ...
                          TitleWidget.boxPemeriksaanFisikSugestion(
                            widget: SearchField(
                              ...
                              controller: _frekuensiNyeri
                                ..text = state.penkajianNyeri.frekuensiNyeri,
                              onSubmit: (value) {},
