...
class AsesmenPengkajianNutrisiKeperawatanWidget extends StatefulWidget {
  const AsesmenPengkajianNutrisiKeperawatanWidget({super.key});

  @override
  State<AsesmenPengkajianNutrisiKeperawatanWidget> createState() =>
      _AsesmenPengkajianNutrisiKeperawatanWidgetState();
}

class _AsesmenPengkajianNutrisiKeperawatanWidgetState
    extends State<AsesmenPengkajianNutrisiKeperawatanWidget> {
                          ...
                          TableRow(children: [
                            ...
                            Container(
                              ...
                              child: IconButton(
                                ...
                                icon:
                                    (state.pengkajianNutrisiResponseModel.n1 ==
                                            "Tidak ada penurunan BB")
                                        ? Text(
                                            "YA",
                                ...
                                style: ElevatedButton.styleFrom(
                                    ...
                                    shape: RoundedRectangleBorder(
                                        borderRadius:
                                            BorderRadius.circular(2.sp))),
                                color: ThemeColor.whiteColor,
                                icon: (state.pengkajianNutrisiResponseModel.n1
                                        .contains(
                                            "Tidak yakin / Tidak tahu / Baju terasa Longgar"))
                                    ? Text(
                                        "YA",
                          ...
                          TableRow(children: [
                            ...
                            Container(
                              ...
                              child: IconButton(
                                ...
                                color: ThemeColor.whiteColor,
                                icon:
                                    (state.pengkajianNutrisiResponseModel.n2 ==
                                            "Ya")
                                        ? Text(
                                            "YA",
                                            style: whiteTextStyle,
                          ...
                          children: [
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    "Bila skor >= 2 Konsultasi ke ahli gizi",
                                    style: blackTextStyle.copyWith(
                                        fontSize: 10.sp),
                                    textAlign: TextAlign.center,
                                  ),
