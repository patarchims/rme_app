...
class DeskripsiSikiContentWidget extends StatefulWidget {
  const DeskripsiSikiContentWidget({super.key});

  @override
  State<DeskripsiSikiContentWidget> createState() =>
      _DeskripsiSikiContentWidgetState();
}

class _DeskripsiSikiContentWidgetState
    extends State<DeskripsiSikiContentWidget> {
