...
class RiwayatAlergiContentWidget extends StatefulWidget {
  const RiwayatAlergiContentWidget({super.key});

  @override
  State<RiwayatAlergiContentWidget> createState() =>
      _RiwayatAlergiContentWidgetState();
}

class _RiwayatAlergiContentWidgetState
    extends State<RiwayatAlergiContentWidget> {
