...
class PengkajianFungsionalKeperawatanWidget extends StatefulWidget {
  const PengkajianFungsionalKeperawatanWidget({super.key});

  @override
  State<PengkajianFungsionalKeperawatanWidget> createState() =>
      _PengkajianFungsionalKeperawatanWidgetState();
}

class _PengkajianFungsionalKeperawatanWidgetState
    extends State<PengkajianFungsionalKeperawatanWidget> {
                  ...
                  children: [
                    ...
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          onPressed: () {
                            context.read<KebidananBloc>().add(
                                OnChangedFungsionalF2(value: denganBantuan));
                          },
                          style: ElevatedButton.styleFrom(
                              backgroundColor: (state.pengkajianFungsional.f2 ==
                                      denganBantuan)
                                  ? ThemeColor.greenColor
                                  : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                    ...
                    Padding(
                        padding: EdgeInsets.all(5.sp), child: const Divider()),
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          onPressed: () {
                            context.read<KebidananBloc>().add(
                                OnChangedFungsionalF3(value: denganBantuan));
                          },
                          style: ElevatedButton.styleFrom(
                              backgroundColor: (state.pengkajianFungsional.f3 ==
                                      denganBantuan)
                                  ? ThemeColor.greenColor
                                  : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                    ...
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          onPressed: () {
                            context.read<KebidananBloc>().add(
                                OnChangedFungsionalF4(value: denganBantuan));
                          },
                          style: ElevatedButton.styleFrom(
                              backgroundColor: (state.pengkajianFungsional.f4 ==
                                      denganBantuan)
                                  ? ThemeColor.greenColor
                                  : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                    ...
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          onPressed: () {
                            context.read<KebidananBloc>().add(
                                OnChangedFungsionalF5(value: denganBantuan));
                          },
                          style: ElevatedButton.styleFrom(
                              backgroundColor: (state.pengkajianFungsional.f5 ==
                                      denganBantuan)
                                  ? ThemeColor.greenColor
                                  : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                    ...
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          onPressed: () {
                            context.read<KebidananBloc>().add(
                                OnChangedFungsionalF6(value: denganBantuan));
                          },
                          style: ElevatedButton.styleFrom(
                              backgroundColor: (state.pengkajianFungsional.f6 ==
                                      denganBantuan)
                                  ? ThemeColor.greenColor
                                  : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                    ...
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          onPressed: () {
                            context.read<KebidananBloc>().add(
                                OnChangedFungsionalF7(value: denganBantuan));
                          },
                          style: ElevatedButton.styleFrom(
                              backgroundColor: (state.pengkajianFungsional.f7 ==
                                      denganBantuan)
                                  ? ThemeColor.greenColor
                                  : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                    ...
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          onPressed: () {
                            context.read<KebidananBloc>().add(
                                OnChangedFungsionalF8(value: denganBantuan));
                          },
                          style: ElevatedButton.styleFrom(
                              backgroundColor: (state.pengkajianFungsional.f8 ==
                                      denganBantuan)
                                  ? ThemeColor.greenColor
                                  : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                    ...
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          onPressed: () {
                            context.read<KebidananBloc>().add(
                                OnChangedFungsionalF9(value: denganBantuan));
                          },
                          style: ElevatedButton.styleFrom(
                              backgroundColor: (state.pengkajianFungsional.f9 ==
                                      denganBantuan)
                                  ? ThemeColor.greenColor
                                  : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                    ...
                    fungsionalMethod(
                      ...
                      icon1: IconButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  (state.pengkajianFungsional.f10 ==
                                          denganBantuan)
                                      ? ThemeColor.greenColor
                                      : ThemeColor.primaryColor,
                              shape: RoundedRectangleBorder(
                          ...
                          children: [
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    state.pengkajianFungsional.keterangan,
                                    style: blackTextStyle.copyWith(
                                        fontSize: 10.sp),
                                    textAlign: TextAlign.center,
                                  ),
