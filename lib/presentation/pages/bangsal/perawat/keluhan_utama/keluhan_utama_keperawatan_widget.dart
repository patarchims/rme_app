...
class KeluhanUtamaKeperawatanWidget extends StatefulWidget {
  const KeluhanUtamaKeperawatanWidget({super.key});

  @override
  State<KeluhanUtamaKeperawatanWidget> createState() =>
              ...
              if (authState is Authenticated) {
                ...
                context.read<PengkajianAwalKeperawatanBloc>().add(
                    OnSavePengkajianAwalKeperawatan(
                        ...
                        pengkajian: state
                            .pengkajianKeperawatanResponseModel.pengkajian));
              }
            },
            widget: RawScrollbar(
