...
class ViewRencanaTindakLanjutWidget extends StatefulWidget {
  const ViewRencanaTindakLanjutWidget({super.key});

  @override
  State<ViewRencanaTindakLanjutWidget> createState() =>
      _RencanaTindakLanjutIGDWigetState();
}

class _RencanaTindakLanjutIGDWigetState
    extends State<ViewRencanaTindakLanjutWidget> {
