...
class ViewInputDignosaWidget extends StatefulWidget {
  final bool enableEdit;
  const ViewInputDignosaWidget({
    super.key,
    required this.enableEdit,
  });
  @override
  State<ViewInputDignosaWidget> createState() => _InputDignosaWidgetState();
}

class _InputDignosaWidgetState extends State<ViewInputDignosaWidget> {
  @override
  void initState() {
    super.initState();
  }
