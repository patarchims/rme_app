...
class AsesmenPasienPageWidget extends StatefulWidget {
  const AsesmenPasienPageWidget({super.key});

  @override
  State<AsesmenPasienPageWidget> createState() =>
      _AsesmenPasienPageWidgetState();
}

class _AsesmenPasienPageWidgetState extends State<AsesmenPasienPageWidget> {
  final ScrollController _scrollController = ScrollController();
  String menuTitle = "";

  @override
  Widget build(BuildContext context) {
    final noRM = ModalRoute.of(context)!.settings.arguments as String;
    context.read<PasienBloc>().add(PasienEvent.selectedNorm(norm: noRM));
    ...
    final singlePasien =
        pasienState.listPasienModel.where((element) => element.mrn == noRM);
    ...
    return Material(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            "${singlePasien.first.namaPasien} - ${singlePasien.first.noreg}",
        ...
        body: BlocBuilder<PasienBloc, PasienState>(
          builder: (context, state) {
            final singlePasien =
                state.listPasienModel.where((element) => element.mrn == noRM);
            return Container(
              width: Get.width,
              height: Get.height - 4,
