...
class HasilPemeriksaanFisioterapiWidget extends StatelessWidget {
  const HasilPemeriksaanFisioterapiWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HasilPenunjangBloc, HasilPenunjangState>(
      builder: (context, state) {
        ...
        return state.getOrSuccessResultFisioterapy.fold(
            () => Container(),
            (a) => a.fold(
                (l) => l.maybeMap(
                      orElse: () {
