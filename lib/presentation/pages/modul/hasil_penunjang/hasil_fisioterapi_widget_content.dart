...
class RiwayatHasilFisioterapiWidgetContent extends StatelessWidget {
  const RiwayatHasilFisioterapiWidgetContent({super.key});
      ...
      builder: (context, state) {
        return BlocBuilder<HasilPenunjangBloc, HasilPenunjangState>(
          builder: (context, state) {
            ...
            return state.getOrSuccessResultFisioterapyOldDB.fold(
                () => Container(),
                (a) => a.fold(
                    (l) => l.maybeMap(
                          orElse: () {
