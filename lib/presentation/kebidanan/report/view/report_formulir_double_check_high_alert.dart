...
class ReportFormulirDoubleCheckHighAlertPage extends StatefulWidget {
  const ReportFormulirDoubleCheckHighAlertPage({super.key});

  @override
  State<ReportFormulirDoubleCheckHighAlertPage> createState() =>
      _ReportFormulirDoubleCheckHighAlertPageState();
}

class _ReportFormulirDoubleCheckHighAlertPageState
    extends State<ReportFormulirDoubleCheckHighAlertPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ReportBloc, ReportState>(
      builder: (context, state) {
        if (state.status == ReportStatus.isLoadingReportCheckAlert) {
          return Scaffold(
