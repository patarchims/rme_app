...
class _$AddUserImpl implements _AddUser {
  ...
  @override
  String toString() {
    return 'AuthEvent.addUser(userModel: $userModel)';
  }
...
abstract class _AddUser implements AuthEvent {
  const factory _AddUser({required final UserModel userModel}) = _$AddUserImpl;
