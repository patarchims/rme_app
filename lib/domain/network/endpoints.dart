abstract class EndPoint {
  ...
  static String asesmenIGD = '/v1/asesmen-awal-igd';
  ...
  static String assesmenAwalAnak = '/v1/asesmen-awal-anak';
  static String pengkajianNyeriAnak = '/v1/pengkajian-nyeri-anak';
